...
const Sidebar = () => {
    ...
    return (
        <aside className={cn("sidebar_responsive sidebar-thin overflow-y-auto min-w-[270px] max-2xl:min-w-[238px]  p-4 rounded-3xl bg-white z-10 max-xl:p-2 max-xl:rounded-b-none max-xl:h-auto max-xl:sidebar_boxshadow", { "min-w-[100px] max-2xl:min-w-[100px]": isPathName })}>
