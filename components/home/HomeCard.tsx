...
const HomeCard = ({ name, icon }: any) => {
    return (
        <div className=" w-full bg-bg2 rounded-xl flex items-center gap-3 flex-grow p-2.5 px-3.5 max-md:flex-col max-md:gap-2 max-md:p-2">
            ...
            <p className="text-accent-1">{name}</p>
        </div>
