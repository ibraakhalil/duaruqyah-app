...
export default function CategorySidebar({ data }) {
    ...
    return (
        <>
            ...
            <div id="duas_sidebar" className="sidebar h-[calc(100vh-110px)] rounded-xl overflow-hidden bg-bg2 max-lg:rounded-l-none">
                ...
                <div className="search flex items-center p-3 border bg-bg rounded-md m-3 gap-2 ">
                    <div className="text-accent-1">
                        <CiSearch />
                    </div>
                    <input onChange={handleSearch} className="outline-none text-[14px] bg-bg border-none" type="text" placeholder="Search by categories" />
                </div>
