...
const Setting = () => {
    ...
    return (
        <>
            <div id="settings" className="sidebar-thin w-[270px] min-w-[270px] h-[calc(100vh-110px)] overflow-y-auto bg-white p-4 transition-all duration-300 rounded-3xl max-2xl:min-w-[340px] max-2xl:fixed max-2xl:rounded-r-none max-2xl:right-0 max-2xl:h-[100vh] max-2xl:top-0 max-2xl:translate-x-full z-20">
